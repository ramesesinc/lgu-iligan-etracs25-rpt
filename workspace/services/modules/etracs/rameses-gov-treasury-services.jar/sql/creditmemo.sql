...
SELECT  
  ba.fund_objid AS fundid, ba.objid AS bankacctid,
  ba.acctid AS itemacctid, ia.code as itemacctcode, 
  ia.title as itemacctname, SUM(cm.amount) AS dr,
  0 AS cr, 'bankaccount_ledger' AS _schemaname 
FROM creditmemo cm
